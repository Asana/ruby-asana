  ...
  module Resources
    class ProjectMembershipsBase < Resource
      ...
      class << self
        ...
        #
        # project_membership_path_gid - [str]  (required)
        ...
        def get_project_membership(client, project_membership_path_gid: required("project_membership_path_gid"), options: {})
          path = "/project_memberships/{project_membership_gid}"
          path["{project_membership_path_gid}"] = project_membership_path_gid
