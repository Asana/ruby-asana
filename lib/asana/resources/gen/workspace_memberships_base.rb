  ...
  module Resources
    class WorkspaceMembershipsBase < Resource
      ...
      class << self
        ...
        #
        # workspace_membership_path_gid - [str]  (required)
        ...
        def get_workspace_membership(client, workspace_membership_path_gid: required("workspace_membership_path_gid"), options: {})
          path = "/workspace_memberships/{workspace_membership_gid}"
          path["{workspace_membership_path_gid}"] = workspace_membership_path_gid
