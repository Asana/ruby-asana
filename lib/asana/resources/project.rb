  ...
  module Resources
    ...
    class Project < Resource
      ...
      class << self
        ...
        # project in.
        def create(data = {}, workspace:, team: nil, client:)
          params = { workspace: workspace, team: team }.reject { |_,v| v.nil? }
          new(body(client.post("/projects", body: params)), client: client)
        end
        ...
        def create_in_team(data = {}, team:, client:)
        ...
        # archived - [Boolean] Only return projects whose `archived` field takes on the value of
        # this parameter.
        def find_by_workspace(workspace:, archived: nil, client:)
        ...
        # archived - [Boolean] Only return projects whose `archived` field takes on the value of
        # this parameter.
        def find_by_team(team:, archived: nil, client:)
          params = { archived: archived }.reject { |_,v| v.nil? }
